        ...
        <CardGroup>
          <Card color="dark" className="aboutus-card">
            ...
            <CardBody>
              ...
              <CardText>
                <br />
                "There are 360 degrees, so why only stick to one? Zaha Hadid"
                <br />
                ~Zaha Hadid
              </CardText>
              <a href="https://www.linkedin.com/in/pdisidoro/"><img src={LinkedIn} className="linkedin-btn"/></a>
            </CardBody>
          </Card>
          <Card color="dark" className="aboutus-card">
            <CardImg
            ...
            <CardBody>
              ...
              <a href="https://www.linkedin.com/in/lillian-mcgillivray-8118315/"><img src={LinkedIn} className="linkedin-btn"/></a>
            </CardBody>
          </Card>
          <Card color="dark" className="aboutus-card">
            <CardImg
            ...
            <CardBody>
              ...
              <CardText>
                <br />
                "Life is a tornado and I'm the cow spinning around for cinematic effect"
                <br />
                ~@69possums420
              </CardText>
              <a href="https://www.linkedin.com/in/Chawwh/"><img src={LinkedIn} className="linkedin-btn"/></a>
            </CardBody>
          </Card>
          <Card color="dark" className="aboutus-card">
            <CardImg
            ...
            <CardBody>
              ...
              <a href="https://www.linkedin.com/in/elias-zerai-b1693a134//Elias"><img src={LinkedIn} className="linkedin-btn"/></a>
            </CardBody>
          </Card>
        </CardGroup>
        </>
